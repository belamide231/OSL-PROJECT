...
export class ApiService {
  ...
  public login = (username: string, password: string): Observable<string> => {
    return this.http.post(this.dns('loginAccount'), { username, password } as loginAccountDto, this.headers).pipe(map((response) => {
      return JSON.parse(response.body as any).role;
    }), catchError((error) => {
      return of(({ 
  ...
  public register = (username: string, password: string): Observable<any> => {
    return this.http.post(this.dns('createAccount'), { username, password }, this.headers).pipe(map((response) => {
      return response;
    }), catchError((error) => {
      return of(error);
    }))
  ...
  public invite = (gmail: string): Observable<number> => {
    return this.http.post(this.dns('invite'), { gmail }, this.headers).pipe(map((response) => {
